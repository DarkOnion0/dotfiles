...
#cp -r ~/.config/rofi/powermenu.rasi ~/Programmation/git/dotfiles/home/.config/rofi/
cp -r ~/.config/rofi/themes ~/Programmation/git/dotfiles/home/.config/rofi/
...
#cp -r ~/.config/kitty/sessions ~/Programmation/git/dotfiles/home/.config/
